...
/**
 * Combined-compartments inert-gas load chart. Returns null when hidden; when
 * shown, the content is rendered directly (no Card wrapper) so it can live
 * inside the dive profile chart card.
 */
export function CompartmentsProfileChart() {
  ...
  return (
    <section className="space-y-2">
      <h3 className="text-sm font-semibold">{t('planner.tabs.compartments')}</h3>
